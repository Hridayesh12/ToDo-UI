...
const MobileNavBar = ({ isSideBarOpen, setIsSideBarOpen }) => {
    const [isOpen, setIsOpen] = useState(false);
    return (
        <div className="flex sm:hidden bg-[#15132B] text-[#6418C3] flex-col text-black justify-between items-center px-2 py-3 drop-shadow-lg">
            ...
            {isOpen ? (
                <>
                    <div className="flex flex-row w-full justify-between items-center border-b-2">
                        <button className="flex w-full flex-row hover:bg-slate-200 p-4 items-center text-base text-[#6418C3]  font-medium">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 20 20"
                                fill="currentColor"
